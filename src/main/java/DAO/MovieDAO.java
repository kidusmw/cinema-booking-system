...
public class MovieDAO {
    ...
    public boolean addMovie(Movie movie) {
        String query =
            "INSERT INTO Movie_ (Title, Genre, Duration, Rating, Poster_Path, M_language, releaseDate, M_description) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        try (
    ...
    public boolean updateMovie(Movie movie) {
        String query =
            "UPDATE Movie_ SET Genre = ?, Duration = ?, Rating = ?, Poster_Path = ?, M_language = ?, releaseDate = ?, M_description = ? WHERE Title = ?";
        try (
            Connection conn = getConnection();
            PreparedStatement ps = conn.prepareStatement(query)
        ) {
            ...
            logger.error("Failed to update movie: {}", movie.getTitle(), e);
            return false;
        }
    }
    ...
    public boolean deleteMovieByName(String title) {
        ...
        try (
            ...
            logger.error("Failed to delete movie: {}", title, e);
            return false;
        }
    }
    ...
    public List<Movie> getMoviesByLanguage(String language) {
        ...
        try (
            ...
            logger.error("Failed to fetch movies by language: {}", language, e);
        }
        return movies;
    }
    ...
    public List<Movie> getMoviesAfterDate(java.util.Date date) {
        ...
        try (
            ...
            logger.error("Failed to fetch movies after date: {}", date, e);
        }
        return movies;
    }
    ...
    public List<Movie> getMoviesBeforeDate(java.util.Date date) {
        ...
        try (
            ...
            logger.error("Failed to fetch movies before date: {}", date, e);
        }
        return movies;
    }
    ...
    public List<Movie> getMoviesWithPosters() {
        List<Movie> movies = new ArrayList<>();
        String query =
            "SELECT * FROM Movie_ WHERE Poster_Path IS NOT NULL AND Poster_Path <> ''";
        try (
            Connection conn = getConnection();
            PreparedStatement ps = conn.prepareStatement(query);
            ResultSet rs = ps.executeQuery()
            ...
            logger.error("Failed to fetch movies with posters", e);
        }
        return movies;
    }
    ...
    public List<Movie> getTopRatedMovies(int limit) {
        ...
        try (
            ...
            logger.error(
                "Failed to fetch top rated movies (limit={})",
                limit,
                e
            );
        }
    ...
    public boolean movieExists(String movieID) {
        ...
        try (
            ...
            logger.error(
                "Failed to check existence of movie ID: {}",
                movieID,
                e
            );
            return false;
