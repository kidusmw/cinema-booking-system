...
public class AuthChoice {
    ...
    public BorderPane getView() {
        ...
        card.getStyleClass().add("p-50-60");
        card.getStyleClass().add("w-450");
        ...
        btnSignUp.getStyleClass().add("h-48");
